...
import payrollData from '../components/payrollData.vue';
...
import emplyexpensesData from '../components/emplyexpensesData.vue';
import mngmtexpensesData from '../components/mngmtexpensesData.vue';
...
const routes = [
  ...
  {
    path: '/emplyexpensesData',
    name: 'emplyexpensesData',
    component: emplyexpensesData
  },
  {
    path: '/mngmtexpensesData',
    name: 'mngmtexpensesData',
    component: mngmtexpensesData
  },
  {
